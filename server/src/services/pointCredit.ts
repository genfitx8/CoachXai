...
/**
 * Server-side point crediting after successful PayApp payment.
 *
 * Strategy:
 ...
 *     (see /api/payments/payapp/apply-local-points). For local dev only.
 */
...
export async function creditPoints(
  ...
  if (db) {
    ...
    const transaction = {
      ...
      description: `PayApp 포인트 충전 (${orderId})`,
      createdAt: now,
    };
