        ...
        <div className="p-8">
          ...
          <div className="grid gap-4">
            <button 
              ...
              className="flex items-center p-4 border-2 border-gray-200 rounded-xl hover:border-emerald-700 hover:bg-emerald-50 transition-all group text-left"
            >
            ...
            <button 
              ...
              className="flex items-center p-4 border-2 border-gray-200 rounded-xl hover:border-emerald-700 hover:bg-emerald-50 transition-all group text-left relative overflow-hidden"
            >
