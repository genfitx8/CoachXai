  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      {clientPackages.length === 0 ? (
        <div className="text-center py-16 bg-white/[0.04] rounded-2xl border border-dashed border-line-subtle">
          ...
          <p className="text-ink-muted font-medium">{t('pkg_no_packages')}</p>
        ...
        <div className="space-y-6">
          {clientPackages.map((pkg) => {
            ...
            return (
              <div
                key={pkg.id}
                className="bg-white/[0.04] rounded-2xl border border-line-subtle shadow-sm overflow-hidden"
              >
                {/* Package header */}
                <div className="flex items-center justify-between px-5 py-4 border-b border-line-subtle bg-emerald-50">
                            ...
                            className={`
                              ...
                              ${
                                isCompleted
                                  ...
                                  : 'border-dashed border-line-subtle bg-white/[0.03] text-ink-muted hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-600'
                              }
                            `}
                          >
                            {isCompleted ? (
      ...
      {showNewPackageModal && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
          <div className="bg-white/[0.04] rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl">
            <div className="bg-white/[0.10] px-6 py-4 flex justify-between items-center text-white">
            ...
            <form onSubmit={handleCreatePackage} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-line-subtle rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none text-center text-2xl font-bold"
                  placeholder="예: 10"
                  autoFocus
                  required
                />
