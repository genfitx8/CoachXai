...
export const LessonPackageManager: React.FC<LessonPackageManagerProps> = ({
  ...
  const handleDeletePackage = (pkg: LessonPackage) => {
    ...
    const msg = hasRecords
      ...
      : `${pkg.totalSessions}회 레슨 패키지를 삭제하시겠습니까?`;
    ...
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <h2 className="text-xl font-bold text-gray-900">레슨 패키지</h2>
      ...
      <div className="flex justify-end">
        ...
        >
          <Plus className="w-4 h-4 mr-2" /> 새 레슨 패키지 등록
        </Button>
      </div>
      ...
      {clientPackages.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-2xl border border-dashed border-gray-300">
          ...
          <p className="text-gray-500 font-medium">등록된 레슨 패키지가 없습니다.</p>
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
          <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl">
            <div className="bg-slate-800 px-6 py-4 flex justify-between items-center text-white">
              <h3 className="font-bold text-lg">새 레슨 패키지 등록</h3>
            ...
            <form onSubmit={handleCreatePackage} className="p-6 space-y-4">
              <div>
                ...
                <label className="block text-xs font-bold text-gray-500 mb-1">
                  레슨 총 횟수 <span className="text-red-500">*</span>
                </label>
                <input
                  type="number"
                  min={MIN_SESSIONS}
