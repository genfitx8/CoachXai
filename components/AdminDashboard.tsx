...
import { Users, FileText, Trash2, LogOut, RefreshCcw, ShieldAlert, CreditCard, CheckCircle, XCircle, Activity, LayoutDashboard, UserX, Database, Video, Mic, Image as ImageIcon, User, Award, Calendar, Cloud, Save, AlertTriangle, ListChecks, Plus, Send, Bell, MessageSquare, Megaphone, MapPin, Briefcase, Search, Eye, EyeOff, Building2 } from 'lucide-react';
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'CLIENTS' | 'LESSONS' | 'SYSTEM' | 'TEMPLATES' | 'MESSAGES' | 'COURSES' | 'BRANCHES' | 'BRANCH_STAFF'>('CLIENTS');
