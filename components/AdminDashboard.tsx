...
import { Users, FileText, Trash2, LogOut, RefreshCcw, ShieldAlert, CreditCard, CheckCircle, XCircle, Activity, LayoutDashboard, UserX, Database, Video, Mic, Image as ImageIcon, User, Award, Calendar, Cloud, Save, AlertTriangle, ListChecks, Plus, Send, Bell, MessageSquare, Megaphone, MapPin, Briefcase, Search, Eye, EyeOff } from 'lucide-react';
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [showMedia, setShowMedia] = useState<boolean>(() => {
    const saved = localStorage.getItem('showMedia');
  ...
  const toggleShowMedia = () => {
      ...
      localStorage.setItem('showMedia', JSON.stringify(newValue));
  };
