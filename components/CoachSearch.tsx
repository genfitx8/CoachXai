    ...
    <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
      ...
      {assignedCoachName ? (
        <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-4 flex items-center gap-3 animate-fade-in">
          ...
          <div className="ml-auto bg-white p-1 rounded-full text-emerald-500 shadow-sm">
          ...
          <div className="relative">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none transition-all"
              />
              <button
                type="button"
                onClick={(e) => {
