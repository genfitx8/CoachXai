  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
        <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl">
            <div className="bg-gradient-to-br from-slate-700 to-slate-900 p-6 text-white text-center relative">
                ...
                <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg text-indigo-600 relative group">
                    ...
                    {!isEditing && (
                        <button 
                            ...
                            className="absolute bottom-0 right-0 p-1.5 bg-slate-600 rounded-full text-white hover:bg-slate-500 transition-colors shadow-sm"
                            title="정보 수정"
                        >
                ...
                <div className="pt-2 space-y-3">
                    {isEditing ? (
                        <div className="flex gap-2">
                             ...
                             <Button onClick={handleSave} isLoading={isSaving} className="flex-1 bg-slate-700 hover:bg-slate-800">
                        ...
                        <>
                            <Button 
                                ...
                                className="w-full bg-white text-slate-700 border border-slate-200 hover:bg-slate-50 shadow-sm"
                            >
