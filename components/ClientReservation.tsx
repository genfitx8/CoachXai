          ...
          <div className="space-y-4">
            {!coachId ? (
              ...
              <div className="bg-white rounded-lg shadow-sm p-12 text-center">
                ...
                <p className="text-gray-500">예약 가능한 시간대가 없습니다.</p>
              </div>
            ) : (
              availableSlots.map((slot) => (
                <div
                  key={slot.id}
                  className="bg-white rounded-lg shadow-sm p-4 hover:shadow-md transition border-l-4 border-green-500"
                >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-gray-700 mb-1">
                        ...
                        <span className="font-medium">
                          {formatDateTime(slot.startTime)} - {new Date(slot.endTime).toLocaleTimeString('ko-KR', { hour: '2-digit', minute: '2-digit' })}
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-gray-600 text-sm">
                        <User className="w-4 h-4 text-gray-400" />
                        <span>{slot.coachName} 코치</span>
                      </div>
                    </div>
                    <Button
