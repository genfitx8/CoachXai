            ...
            <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                        <div className="flex-1 relative">
                            <input
                                ...
                                placeholder="0"
                                min="0"
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-right pr-8"
                            />
                ...
                <div className="w-full">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        placeholder="예: 85"
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all font-bold text-gray-900"
                    />
                </div>
                                        ...
                                        <div className="bg-white p-4 rounded-lg border-2 border-emerald-100 shadow-sm animate-fade-in space-y-3">
                                            <div className="grid grid-cols-2 gap-2">
                                                <input 
                                                    ...
                                                    className="w-full px-3 py-2 border border-gray-300 rounded text-sm focus:ring-1 focus:ring-emerald-500 outline-none"
                                                    autoFocus
                                                />
                                                <input 
                                                    type="text" 
                                            ...
                                            <div className="flex gap-2 justify-end pt-1">
                                                ...
                                                <button 
                                                    type="button" 
                                                    onClick={saveNewClub}
                                                    className="px-3 py-1.5 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 rounded"
                                                >
                                                    추가
                                                </button>
                                            </div>
