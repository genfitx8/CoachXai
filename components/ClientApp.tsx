...
import { User, LogOut, History, PlayCircle, Plus, BarChart3, Bell, Sparkles, ListChecks, Globe, Calendar, Search, Filter, Eye, EyeOff, ChevronRight, TrendingUp, Award } from 'lucide-react';
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="grid grid-cols-3 gap-3 mb-4">
                            <div className="glass rounded-xl p-3 text-center">
                                ...
                                <div className="text-[10px] text-gray-600 font-semibold mt-1">총 레슨</div>
                            </div>
                            <div className="glass rounded-xl p-3 text-center">
                            ...
                            <div className="glass rounded-xl p-3 text-center">
                                ...
                                <div className="text-[10px] text-gray-600 font-semibold mt-1">최근 레슨</div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-2">
                            <button 
                                ...
                                className="flex-1 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white rounded-lg px-4 py-2.5 text-sm font-bold transition-all flex items-center justify-center gap-2 border border-white/20 hover:scale-[1.02]"
                            >
