...
export const ClientApp: React.FC<ClientAppProps> = ({ clientProfile, allLessons, onLogout, onUpdateLesson, onSaveNewRecord, onDeleteLesson, onUpdateProfile }) => {
  ...
  const [view, setView] = useState<ViewState | 'STATS' | 'PROFILE' | 'CALENDAR_INTEGRATION'>('LIST');
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            <button 
                                ...
                                className="bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white rounded-lg px-2 py-2.5 text-xs font-bold transition-all flex items-center justify-center gap-1.5 border border-white/20 hover:scale-[1.02]"
                            >
