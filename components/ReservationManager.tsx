...
import { Calendar, Clock, User, Phone, CheckCircle, XCircle, Plus, ArrowLeft, Filter } from 'lucide-react';
...
export const ReservationManager: React.FC<ReservationManagerProps> = ({ coachProfile, onBack }) => {
  ...
  const handleCreateSlot = async (e: React.FormEvent) => {
    ...
    try {
      await reservationService.createAvailableSlot(
        coachProfile.id,
        coachProfile.name,
        startDateTime,
        endDateTime,
      ...
      alert(error.message || '시간대 생성에 실패했습니다.');
    }
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 shadow-sm">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {reservations.filter(r => r.status === 'AVAILABLE').length}
            </p>
          </div>
        </div>
        ...
        {showCreateForm && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-lg font-semibold mb-4">예약 가능 시간대 생성</h2>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-4">
          <div className="flex items-center gap-2 overflow-x-auto">
            ...
            <button
              ...
              className={`px-3 py-1 rounded-full text-sm font-medium transition whitespace-nowrap ${
                filterStatus === 'AVAILABLE' ? 'bg-gray-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
            >
              예약 가능
            </button>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    {(reservation.status === 'AVAILABLE' || reservation.status === 'CONFIRMED') && (
                      <button
