...
import { Calendar, Clock, User, Phone, CheckCircle, XCircle, ArrowLeft, Filter, Settings, Save, ChevronLeft, ChevronRight, Ban, PlusCircle } from 'lucide-react';
                ...
                <>
                  {workStart !== null && workEnd !== null && (
                    <p className="text-xs text-gray-500 mb-3">
                      ...
                      {' '}· 예약 가능 슬롯을 클릭하면 회원 예약을 바로 등록할 수 있습니다.
                    </p>
                  )}
