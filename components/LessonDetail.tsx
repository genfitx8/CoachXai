...
import { sendLessonNoteViaKakao } from '../services/kakaoShareService';
        ...
        <div className="max-w-4xl mx-auto p-4 space-y-6">
          ...
          <div className="pt-4 flex flex-col gap-2">
              ...
              {kakaoShareStatus === 'no_key' && (
                  <p className="text-center text-xs text-amber-600 bg-amber-50 rounded-lg px-3 py-2">
                      카카오톡 공유 기능이 설정되지 않았습니다. 관리자에게 문의해 주세요.
                  </p>
              )}
