      ...
      <div className="space-y-2">
        <div className="flex gap-2">
          ...
          <Button
            ...
            className="flex items-center gap-1.5 bg-emerald-500 hover:bg-emerald-600 text-white text-sm py-2 px-4 flex-shrink-0"
          >
              ...
              <div className="flex items-center gap-3">
                <span
                  className={`inline-block w-2 h-2 rounded-full flex-shrink-0 ${
                    bay.isActive ? 'bg-emerald-400' : 'bg-gray-400'
                  }`}
                />
