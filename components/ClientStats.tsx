                    ...
                    {shotSummary && (
                        <div className="space-y-4">
                            ...
                            <div className="bg-white rounded-xl shadow-lg border border-emerald-100/50 overflow-hidden">
                                <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 px-4 py-3 border-b border-emerald-600 flex justify-between items-center">
                                ...
                                <div className="p-4 grid grid-cols-2 gap-4">
                                    ...
                                    <div className="col-span-2 grid grid-cols-2 gap-3 mt-2">
                                        <div className="bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-600 rounded-xl p-4 text-white shadow-xl shadow-emerald-500/40 hover:shadow-2xl hover:shadow-emerald-500/50 transition-all duration-300 transform hover:-translate-y-1">
                                        ...
                                        <div className="bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-600 rounded-xl p-4 text-white shadow-xl shadow-indigo-500/40 hover:shadow-2xl hover:shadow-indigo-500/50 transition-all duration-300 transform hover:-translate-y-1">
                                            <div className="flex items-center gap-1 opacity-90 mb-1 text-xs font-semibold">
                            ...
                            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-md hover:shadow-lg transition-shadow">
                                <h3 className="font-bold text-gray-900 mb-4 text-sm flex items-center gap-2">
                                    <span className="w-1.5 h-5 bg-gradient-to-b from-emerald-500 to-emerald-600 rounded-full shadow-sm"></span>
                                    비거리 변화 (Total & Carry)
                                </h3>
                            ...
                            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-md hover:shadow-lg transition-shadow">
                                <h3 className="font-bold text-gray-900 mb-4 text-sm flex items-center gap-2">
                                    <span className="w-1.5 h-5 bg-gradient-to-b from-indigo-500 to-indigo-600 rounded-full shadow-sm"></span>
                                    스피드 변화 (Ball & Head)
                                </h3>
                                <div className="h-56 w-full">
                                        <ResponsiveContainer width="100%" height="100%">
                                            ...
                                            <>
                                                ...
                                                <div className="bg-white rounded-xl border border-gray-100 p-4">
                                                    ...
                                                    <div className="flex justify-center gap-4 mt-3 text-xs text-gray-500">
                                                        ...
                                                        <div className="flex items-center gap-1"><div className="w-3 h-3 bg-emerald-500 rounded"></div> Round 2</div>
                                                    </div>
                                                </div>
                                            </>
                                        )}
