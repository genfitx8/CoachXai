...
export const DiagnosisResultSummary: React.FC<DiagnosisResultSummaryProps> = ({
  ...
  return (
    <section className="rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-slate-900 to-slate-800 p-6">
      ...
      <div className="mt-4 flex items-center gap-3">
        <div className="rounded-xl bg-emerald-500/20 px-4 py-2 text-sm font-semibold text-emerald-200">종합 등급 {grade}</div>
