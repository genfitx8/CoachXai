...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-gradient-to-r from-indigo-600 to-violet-600 text-white hover:from-indigo-500 hover:to-violet-500 focus:ring-indigo-500 shadow-lg shadow-indigo-900/30 hover:shadow-xl hover:shadow-violet-900/35",
    secondary: "bg-slate-900 text-slate-100 border border-slate-700 hover:bg-slate-800 hover:border-slate-600 focus:ring-indigo-500 shadow-md hover:shadow-lg",
    ...
    ghost: "bg-transparent text-slate-300 hover:bg-slate-800/70 hover:text-white focus:ring-indigo-500"
  };
