...
export const GolfAIAgent: React.FC<GolfAIAgentProps> = ({
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      {/* Hero Banner */}
      <div className="bg-gradient-to-br from-indigo-500 via-purple-600 to-indigo-700 rounded-2xl p-6 text-white text-center shadow-xl">
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 disabled:opacity-60 text-white rounded-2xl px-6 py-4 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3 font-bold text-base"
      >
        {isGenerating ? (
          <>
