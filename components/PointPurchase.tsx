    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50">
      ...
      <div className="p-4 max-w-md mx-auto space-y-4 pt-6">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 disabled:from-gray-300 disabled:to-gray-400 text-white rounded-2xl py-4 font-bold text-base shadow-lg shadow-emerald-200 disabled:shadow-none transition-all flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
