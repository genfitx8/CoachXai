      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-3">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button
            onClick={fetchData}
            disabled={loading}
            className="flex items-center gap-1.5 bg-emerald-500 hover:bg-emerald-600 text-white text-sm py-1.5 px-4"
          >
                  ...
                  {res.status === 'CANCEL_REQUESTED' && (
                    <div className="flex gap-2 pt-2 border-t border-orange-100">
                      <button
                        ...
                        className="flex items-center gap-1 px-3 py-1.5 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition text-xs font-medium disabled:opacity-50"
                      >
