        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
                <div className="bg-black rounded-xl overflow-hidden shadow-lg relative aspect-video group">
                    {viewMode === 'SPLIT' || !allowGhostMode ? (
                        <div className="grid grid-cols-2 h-full">
                            ...
                            <div className="relative bg-gray-900 flex items-center justify-center">
                                ...
                                <div className="absolute top-2 left-2 bg-emerald-600/80 text-white text-xs px-2 py-1 rounded z-10">
                        ...
                        <div className="relative w-full h-full bg-gray-900 flex items-center justify-center">
                            ...
                            {renderMedia(newLesson, video2Ref, "absolute inset-0 w-full h-full object-contain opacity-80 mix-blend-normal")}
                             ...
                             <div className="absolute top-2 left-2 flex gap-2 z-10">
                                <span className="bg-gray-600/80 text-white text-xs px-2 py-1 rounded">Before (흑백)</span>
                                <span className="bg-emerald-600/80 text-white text-xs px-2 py-1 rounded">After (컬러)</span>
                             </div>
                        </div>
                    )}
                    ...
                    {/* Controls */}
                    {showControls && (
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex justify-center gap-4 z-20">
                            <button 
                            ...
                            <div className="flex bg-white/20 backdrop-blur-md rounded-lg p-1">
                                <button 
                                    ...
                                    className={`p-2 rounded ${viewMode === 'SPLIT' ? 'bg-white text-black shadow-sm' : 'text-white hover:bg-white/10'}`}
                                    title="나란히 보기"
                                >
                                ...
                                <button 
                                    ...
                                    className={`p-2 rounded ${viewMode === 'GHOST' ? 'bg-white text-black shadow-sm' : 'text-white hover:bg-white/10'}`}
                                    title="겹쳐 보기 (고스트 모드)"
                                >
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                    <div className="flex items-center gap-2 mb-2">
                         ...
                         <div className="text-xs px-2 py-0.5 bg-gray-100 text-gray-500 rounded-full">AI 추정</div>
                    </div>
