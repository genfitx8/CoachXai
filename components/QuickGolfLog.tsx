    ...
    <div className="space-y-5 animate-fade-in pb-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-2xl px-8 py-4 shadow-lg font-black text-base transition-all transform hover:scale-[1.02] active:scale-[0.98]"
        >
