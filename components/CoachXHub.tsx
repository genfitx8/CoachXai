...
}> = ({ report, memberLessons, onAskCoachX }) => {
  const { t } = useLanguage();
    ...
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      {expanded && (
        <div className="border-t border-gray-100">
          ...
          {/* Ask CoachX shortcut – shown when expanded regardless of active tab */}
          <div className="border-t border-gray-50 px-4 py-3">
            <button
              onClick={() => onAskCoachX(report.clientName)}
              className="w-full flex items-center justify-center gap-2 text-xs font-semibold text-violet-700 bg-violet-50 hover:bg-violet-100 active:bg-violet-200 rounded-lg py-2.5 transition-colors"
            >
