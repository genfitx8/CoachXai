...
import { CoachXPreviewStrip } from './components/CoachXPreviewStrip';
import {
  Plus,
  Search,
  Filter,
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <header className="bg-gradient-to-r from-white via-violet-50/40 to-white border-b border-violet-100/60 shadow-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          >
            <div className="bg-gradient-to-br from-violet-600 to-indigo-600 p-2 rounded-xl shadow-md shadow-violet-500/30 text-white">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-6">
        {coachView === 'LIST' && (
          <div className="space-y-6 animate-fade-in">
            ...
            <button
              ...
              className="w-full relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-violet-950 to-indigo-950 p-5 flex items-center gap-4 shadow-xl shadow-violet-900/20 group hover:shadow-violet-800/30 transition-all duration-300"
            ...
            >
              ...
              <div className="relative w-14 h-14 flex-shrink-0">
                <div className="absolute inset-0 rounded-full bg-violet-500/30 animate-ping" style={{ animationDuration: '2.5s' }} />
                <div className="absolute inset-1 rounded-full bg-violet-500/20 animate-ping" style={{ animationDuration: '2.5s', animationDelay: '0.8s' }} />
                <div className="absolute inset-2 rounded-full bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center shadow-lg" style={{ animation: 'coachx-breathe-app 3s ease-in-out infinite' }}>
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-xs text-violet-300 mt-0.5">{t('coachx_entry_desc')}</p>
              </div>

              <ChevronRight className="w-5 h-5 text-white/40 group-hover:text-white/70 transition-colors flex-shrink-0" />
            </button>

            {/* ── CoachX Live Preview Strip ────────────────────────────── */}
            {allCoachLessons.length > 0 && (
              <CoachXPreviewStrip
                lessons={allCoachLessons}
                clients={clients}
                onOpenCoachX={() => setCoachView('COACHX')}
              />
            )}
        ...
        {coachView === 'COACHX' && currentUser && 'id' in currentUser && (
          <CoachXHub
            ...
            clients={clients}
            onBack={() => setCoachView('LIST')}
            onOpenChat={() => setCoachView('COACHX_CHAT')}
          />
        )}
