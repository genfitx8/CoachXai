...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      {/* Calendar Section */}
      {coachView === 'LIST' && currentUser && 'id' in currentUser && (
          ...
          <div className="max-w-7xl mx-auto px-4 py-4">
            <CalendarView
              ...
              onCoachCreateForMember={(date, hour) => {
                setCoachLessonModalDate(date);
                setCoachLessonModalHour(hour);
                setShowCoachLessonModal(true);
              }}
            />
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex flex-col gap-3 w-full md:w-auto">
                <Button
                  ...
                  className="w-full md:w-auto px-8 py-3 text-lg shadow-lg shadow-violet-200 bg-violet-600 hover:bg-violet-700"
                ...
                <Button
                  ...
                  className="w-full md:w-auto px-8 py-3 text-lg shadow-lg shadow-green-200 bg-green-600 hover:bg-green-700"
                ...
                <Button
                  ...
                  className="w-full md:w-auto px-8 py-3 text-lg shadow-lg shadow-emerald-200 bg-emerald-600 hover:bg-emerald-700"
                ...
                <Button
                  ...
                  className="w-full md:w-auto px-8 py-3 text-lg shadow-lg shadow-teal-200 bg-teal-600 hover:bg-teal-700"
                  icon={<Target className="w-5 h-5" />}
                >
                  나의 타석 예약
                </Button>
                <Button
                  ...
                  className="w-full md:w-auto px-8 py-3 text-lg shadow-lg shadow-orange-200 bg-orange-600 hover:bg-orange-700"
