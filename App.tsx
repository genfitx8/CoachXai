  ...
  return (
    <div className="min-h-screen bg-bg-base text-ink-high flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-6 md:py-8">
        {coachView === 'LIST' && (
          <CoachHomeView
            coachName={currentUser && 'id' in currentUser ? currentUser.name : ''}
            coachLabel={t('coach')}
            onStartLesson={() => setCoachView('NEW')}
            onOpenStudents={() => setCoachView('CLIENTS')}
            onOpenLessonUpload={() => setCoachView('LESSON_UPLOAD')}
