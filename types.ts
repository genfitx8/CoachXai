...
export interface NotificationMessage {
  ...
  clientId?: string; // Optional: restrict delivery to a specific client
}
...
export interface ClientProfile {
  ...
  // Added: Push notification token (FCM/Web Push)
  pushToken?: string;
}
...
export interface LessonReservation {
  ...
  createdAt: number;
  updatedAt: number;
  confirmationNotifiedAt?: number; // Timestamp when confirmation notification was sent (dedup)
}
