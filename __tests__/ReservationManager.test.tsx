...
describe('ReservationManager – slot click interactions', () => {
  ...
  it('clicking an available slot calls toggleHourSlot with correct args', async () => {
    render(<ReservationManager coachProfile={COACH} onBack={vi.fn()} initialDate={TEST_DATE} />);
  ...
  it('refreshes reservations after a slot is toggled', async () => {
    render(<ReservationManager coachProfile={COACH} onBack={vi.fn()} initialDate={TEST_DATE} />);
  ...
  it('does not refresh reservations when toggleHourSlot throws', async () => {
